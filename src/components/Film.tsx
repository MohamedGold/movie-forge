...
//       >
//         <Slider sliderKey='trailer-slider' isTrailerCard={true} trailers={trailers}>
//           {(onSwipe) =>
...
//       >
//         <Slider sliderKey='season-slider'
//           isSeasonsCard={true}
//           season={film.seasons}
...
//       >
//         <Slider sliderKey='recommendations-slider' isMoviesCard={true}>
//           {(onSwipe) =>
